                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="table-responsive table--no-card m-b-40">
                                    <button class="au-btn au-btn-icon au-btn--blue" id='add_group'>
                                        <i class="zmdi zmdi-plus" ></i>add new group
                                    </button>
                                    ...
                                    <form method="post" action="admin" class="emp-group">
                                        ...
                                        <select class="form-control" name="name">
                                            ...
                                            <input type="number" readonly class="form-control" name="group_id" value = {{$key + 1}}>
                                            </div>
                                            <button class="btn btn-info">
                                                save
                                            </button>
                                    </form>
                                    <button class="btn btn-info add_new_employee">
                                        <i class="fa fa-star"></i> Change
                                    </button>
